...
file.add_command(
    label="Save as", compound=tk.LEFT, accelerator="Ctrl+sft+s", command=Save_as_file
)
...
file.add_command(label="Exit", compound=tk.LEFT, accelerator="Ctrl+", command=Exit_fun)
# Edit menu
